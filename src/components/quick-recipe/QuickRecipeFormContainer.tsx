...
export function QuickRecipeFormContainer() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Enhanced decorative elements with contained positioning */}
      <div className="absolute -top-8 left-0 w-20 h-20 md:w-32 md:h-32 bg-recipe-green/20 rounded-full blur-md z-0 animate-pulse"></div>
      <div className="absolute -bottom-10 right-0 w-24 h-24 md:w-40 md:h-40 bg-recipe-orange/20 rounded-full blur-md z-0 animate-pulse" style={{ animationDelay: "1s" }}></div>
      <div className="absolute top-1/2 right-4 w-16 h-16 md:w-24 md:h-24 bg-recipe-blue/15 rounded-full blur-md z-0 animate-pulse" style={{ animationDelay: "1.5s" }}></div>
