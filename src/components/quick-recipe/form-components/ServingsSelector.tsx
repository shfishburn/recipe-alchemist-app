 ...
 * Date: 2025-05-10
 *
 * fix(checkmark): adjust item padding and icon offset to avoid overlap
 * - Updated SelectItem padding from pl-8 to pl-10
 * - Changed indicator wrapper from left-2 to left-3 for better clearance
 */
