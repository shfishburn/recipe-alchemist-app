...
export function useNutritionData(recipe: Recipe, profile: Profile | null) {
  ...
  const recipeNutrition = React.useMemo(() => {
    ...
    const enhancedData: ExtendedNutritionData = {
      ...
      sugar: standardizedNutrition.sugar_g || standardizedNutrition.sugar || 0,
      sodium: standardizedNutrition.sodium_mg || standardizedNutrition.sodium || 0,
      vitamin_a: standardizedNutrition.vitamin_a_iu || standardizedNutrition.vitamin_a || 0,
      vitamin_c: standardizedNutrition.vitamin_c_mg || standardizedNutrition.vitamin_c || 0,
      vitamin_d: standardizedNutrition.vitamin_d_iu || standardizedNutrition.vitamin_d || 0,
      calcium: standardizedNutrition.calcium_mg || standardizedNutrition.calcium || 0,
      iron: standardizedNutrition.iron_mg || standardizedNutrition.iron || 0,
      potassium: standardizedNutrition.potassium_mg || standardizedNutrition.potassium || 0,
      ...
      sugarPercentage: getDailyValuePercentage('sugar', standardizedNutrition.sugar_g || standardizedNutrition.sugar || 0),
      sodiumPercentage: getDailyValuePercentage('sodium', standardizedNutrition.sodium_mg || standardizedNutrition.sodium || 0),
      vitamin_a_percentage: getDailyValuePercentage('vitamin_a', standardizedNutrition.vitamin_a_iu || standardizedNutrition.vitamin_a || 0),
      vitamin_c_percentage: getDailyValuePercentage('vitamin_c', standardizedNutrition.vitamin_c_mg || standardizedNutrition.vitamin_c || 0),
      vitamin_d_percentage: getDailyValuePercentage('vitamin_d', standardizedNutrition.vitamin_d_iu || standardizedNutrition.vitamin_d || 0),
      calcium_percentage: getDailyValuePercentage('calcium', standardizedNutrition.calcium_mg || standardizedNutrition.calcium || 0),
      iron_percentage: getDailyValuePercentage('iron', standardizedNutrition.iron_mg || standardizedNutrition.iron || 0),
      potassium_percentage: getDailyValuePercentage('potassium', standardizedNutrition.potassium_mg || standardizedNutrition.potassium || 0),
    };
