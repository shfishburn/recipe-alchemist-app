      ...
      <ScrollArea className="max-h-[120px] pr-2">
        <div className="flex flex-wrap gap-1 sm:gap-2">
          {questions.map((question, index) => (
            <button
              key={index}
              className="text-xs sm:text-sm px-3 py-1.5 bg-gray-100 hover:bg-gray-200 rounded-full text-left text-slate-800 border border-gray-200 transition-colors max-w-full truncate touch-target"
