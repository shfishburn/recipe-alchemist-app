    ...
    <form onSubmit={handleSubmit} className="sticky bottom-0 pt-2 sm:pt-4">
      <div className="flex gap-1 sm:gap-2 items-end">
        ...
        <div className={cn(
          ...
          isFocused ? "ring-2 ring-green-500 ring-opacity-50 rounded-2xl" : "",
          ...
          <Textarea
            ...
            className={cn(
              ...
              isFocused && "border-green-500 border-opacity-50"
            )}
            rows={isMobile ? 2 : 2}
          />
        ...
        <Button 
          ...
          className={cn(
            "rounded-full h-10 w-10 sm:h-12 sm:w-12 p-0 bg-[#06c167] hover:bg-[#05a958] active:bg-[#049c4f]",
